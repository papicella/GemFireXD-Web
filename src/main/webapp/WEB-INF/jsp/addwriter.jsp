...
<head>
    ...
    <SCRIPT language=Javascript>
        ...
        function validate()
        {
            ...
            else if (document.getElementById("functionString").value == "")
            {
    ...
    <title><fmt:message key="sqlfireweb.appname" /> Add Table Writer</title>
</head>
<body>

<h2><fmt:message key="sqlfireweb.appname" /> Add Table Writer</h2>
...
<h3>Table Writer Properties</h3>

<form:form action="addwriter" method="POST" modelAttribute="writerAttribute" onsubmit="return validate()">
    <table>
        <thead>
        <tr>
            <th colspan="3">Table Writer Properties</th>
        </tr>
        </thead>
        <tbody>
        </tbody>
        <tr class="odd">
            ...
            <td>The schema of the table to which the writer is added</td>
        </tr>
        <tr class="even">
            ...
            <td>Table name to which the writer is added. </td>
        </tr>
        <tr class="odd">
            <td align="right">Function Name</td>
            <td>
                <form:input type="text" path="functionString" size="20" maxlength="200"  />
            </td>
        ...
        <tr class="even">
            ...
            <td>
                <form:input type="text" path="initInfoString" size="20" maxlength="400"  />
            </td>
            <td>A string of initialization parameter values to pass to the init method of the writer implementation after calling its default constructor</td>
        </tr>
        <tr class="odd">
