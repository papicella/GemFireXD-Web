...
Found ${records} diskstore(s).
    <a href="creatediskstore">
        <img class="icon" width="16" height="16" src="../themes/original/img/add16.gif" alt="Add Disk Store" title="Add Disk Store" />
        Create Disk Store
    </a>
</div>
