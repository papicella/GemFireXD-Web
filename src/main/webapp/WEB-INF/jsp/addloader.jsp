...
<head>
    ...
    <title><fmt:message key="sqlfireweb.appname" /> Add Table Loader</title>
</head>
<body>

<h2><fmt:message key="sqlfireweb.appname" /> Add Table Loader</h2>
...
<h3>Table Loader Properties</h3>

<form:form action="addloader" method="POST" modelAttribute="loaderAttribute" onsubmit="return validate()">
    <table>
        <thead>
        <tr>
            <th colspan="3">Table Loader Properties</th>
        </tr>
        </thead>
        <tbody>
        </tbody>
        <tr class="odd">
            ...
            <td>The schema of the table to which the loader is added</td>
        </tr>
        <tr class="even">
            ...
            <td>Table name to which the loader is added. </td>
        </tr>
        <tr class="odd">
            ...
            <td>The fully-qualified class name of the RowLoader implementation</td>
        </tr>
        <tr class="even">
            ...
            <td>A string of initialization parameter values to pass to the init method of the loader implementation after calling its default constructor</td>
        </tr>
        </tbody>
    </table>
    <br />
